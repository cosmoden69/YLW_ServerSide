...
{
    public class RptAdjSLSurvDmgRptGoods2
    {
        private string myPath = Application.StartupPath;

        public RptAdjSLSurvDmgRptGoods2(string path)
        {
            this.myPath = path;
        }
        ...
        public Response GetReport(ReportParam para, ref string rptPath, ref string rptName)
        {
            try
            {
                ...
                string sSampleXSD = myPath + @"\보고서\출력설계_2542_서식_손해사정서(재물-대물).xsd";
                ...
                string sSampleDocx = myPath + @"\보고서\출력설계_2542_서식_손해사정서(재물-대물)_Head.docx";
                string sSample1Relt = myPath + @"\보고서\Temp\" + Guid.NewGuid().ToString() + ".docx";
                RptAdjSLSurvDmgRptGoods2_Head toHead = new RptAdjSLSurvDmgRptGoods2_Head();
                ...
                if (dtB != null)
                {
                    for (int ii = 0; ii < dtB.Rows.Count; ii++)
                    {
                        ...
                        sSampleXSD = myPath + @"\보고서\출력설계_2542_서식_손해사정서(재물-대물)_Object.xsd";
                        ...
                        sSampleDocx = myPath + @"\보고서\출력설계_2542_서식_손해사정서(재물-대물)_Object.docx";
                        sSampleAddFile = myPath + @"\보고서\Temp\" + Guid.NewGuid().ToString() + ".docx";
                        RptAdjSLSurvDmgRptGoods2_Object toWord = new RptAdjSLSurvDmgRptGoods2_Object();
                ...
                sSampleDocx = myPath + @"\보고서\출력설계_2542_서식_손해사정서(재물-대물)_Tail.docx";
                sSampleAddFile = myPath + @"\보고서\Temp\" + Guid.NewGuid().ToString() + ".docx";
                RptAdjSLSurvDmgRptGoods2_Tail toTail = new RptAdjSLSurvDmgRptGoods2_Tail();
                ...
                rptName = "손해사정서_재물_대물(" + sfilename + ").docx";
