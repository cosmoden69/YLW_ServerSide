...
{
    public class RptAdjSLRptSurvRptPersDmg1528
    {
        private string myPath = Application.StartupPath;

        public RptAdjSLRptSurvRptPersDmg1528(string path)
        {
            this.myPath = path;
        }
        ...
        public Response GetReport(ReportParam para, ref string rptPath, ref string rptName)
        {
            try
            {
                ...
                string sSampleXSD = myPath + @"\보고서\출력설계_1528_서식_손해사정서 교부 동의 및 확인서_흥국화재.xsd";
                ...
                string sSampleDocx = myPath + @"\보고서\출력설계_1528_서식_손해사정서 교부 동의 및 확인서_흥국화재.docx";
        ...
        private string SetSample1(string sDocFile, string sXSDFile, DataSet pds, string sWriteFile)
        {
            ...
            try
            {
                ...
                using (WordprocessingDocument wDoc = WordprocessingDocument.Open(sWriteFile, true))
                {
                    ...
                    Table oTblA = rUtil.GetTable(lstTable, "@db2IsrtOthTel@"); //수신방법 표
                    ...
                    if (dtB != null)
                    {
                        ...
                        foreach (DataColumn col in dtB.Columns)
                        {
                            ...
                            { //계약자
                                if (sValue == "300113001") { sValue = "☑ 동의함 □ 동의하지 않음"; }
                                else { sValue = "□ 동의함 ☑ 동의하지 않음"; }
                            }
                            ...
                            //수신방법 - 받을 곳(ADJ_손해사정서수신방법)
                            if (col.ColumnName == "IsrtOthTel")
                            { //계약자
                                if (IsrtGuidRcvMthd == "300112001") { db2IsrtOthTel = "☑ 휴대문자(사진포함) : " + sValue + "\n□ 기타(Fax, E-Mail, 주소) : "; }
                                else if ((IsrtGuidRcvMthd == "300112002") || (IsrtGuidRcvMthd == "300112003") || (IsrtGuidRcvMthd == "300112004") || (IsrtGuidRcvMthd == "300112005"))
                                { db2IsrtOthTel = "□ 휴대문자(사진포함) : \n☑ 기타(Fax, E-Mail, 주소) : " + sValue; }
                                else { db2IsrtOthTel = "□ 휴대문자(사진포함) : \n□ 기타(Fax, E-Mail, 주소) : "; }
                            }
                            if (col.ColumnName == "IsrdOthTel")
                            { //피보험자
                                if (IsrdGuidRcvMthd == "300112001") { db2IsrdOthTel = "☑ 휴대문자(사진포함) : " + sValue + "\n□ 기타(Fax, E-Mail, 주소) : "; }
                                else if ((IsrdGuidRcvMthd == "300112002") || (IsrdGuidRcvMthd == "300112003") || (IsrdGuidRcvMthd == "300112004") || (IsrdGuidRcvMthd == "300112005"))
                                { db2IsrdOthTel = "□ 휴대문자(사진포함) : \n☑ 기타(Fax, E-Mail, 주소) : " + sValue; }
                                else { db2IsrdOthTel = "□ 휴대문자(사진포함) : \n□ 기타(Fax, E-Mail, 주소) : "; }
                            }
                            if (col.ColumnName == "BnfcOthTel")
                            { //수익자
                                if (BnfcGuidRcvMthd == "300112001") { db2BnfcOthTel = "☑ 휴대문자(사진포함) : " + sValue + "\n□ 기타(Fax, E-Mail, 주소) : "; }
                                else if ((BnfcGuidRcvMthd == "300112002") || (BnfcGuidRcvMthd == "300112003") || (BnfcGuidRcvMthd == "300112004") || (BnfcGuidRcvMthd == "300112005"))
                                { db2BnfcOthTel = "□ 휴대문자(사진포함) : \n☑ 기타(Fax, E-Mail, 주소) : " + sValue; }
                                else { db2BnfcOthTel = "□ 휴대문자(사진포함) : \n□ 기타(Fax, E-Mail, 주소) : "; }
                            }
