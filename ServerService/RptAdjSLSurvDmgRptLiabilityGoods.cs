...
{
    public class RptAdjSLSurvDmgRptLiabilityGoods
    {
        private string myPath = Application.StartupPath;

        public RptAdjSLSurvDmgRptLiabilityGoods(string path)
        {
            this.myPath = path;
        }
        ...
        public Response GetReport(ReportParam para, ref string rptPath, ref string rptName)
        {
            try
            {
                ...
                string sSampleXSD = myPath + @"\보고서\출력설계_2641_서식_교부용 손해사정서_배상_표준.xsd";
                ...
                string sSampleDocx = myPath + @"\보고서\출력설계_2641_서식_교부용 손해사정서_배상_표준.docx";
