...
{
    public class RptAdjSLRptSurvRptPersMid
    {
        private string myPath = Application.StartupPath;

        public RptAdjSLRptSurvRptPersMid(string path)
        {
            this.myPath = path;
        }
        ...
        public Response GetReport(ReportParam para, ref string rptPath, ref string rptName)
        {
            try
            {
                ...
                string sSampleXSD = myPath + @"\보고서\출력설계_1511_서식_중간보고서_표준.xsd";
                ...
                string sSampleDocx = myPath + @"\보고서\출력설계_1511_서식_중간보고서_표준.docx";
                ...
                {
                    sSampleDocx = myPath + @"\보고서\출력설계_1511_서식_중간보고서_표준_Image.docx";
                ...
                rptName = "중간보고서_인보험(" + sfilename + ").docx";
