...
{
    public class RptAdjSLSurvMidRptGoods2_Head
    {
            ...
            try
            {
                ...
                using (WordprocessingDocument wDoc = WordprocessingDocument.Open(sWriteFile, true))
                {
                    ...
                    if (dtB != null)
                    {
                        ...
                        //2.보험계약사항 - 담보위험
                        Table oTableC = rUtil.GetSubTable(oTbl보험계약사항, "@B3InsurObjDvs@");
                        if (oTableC != null)
                        {
                            //테이블의 중간에 삽입
                ...
                using (WordprocessingDocument wDoc = WordprocessingDocument.Open(sWriteFile, true))
                {
                    ...
                    Table oTableC = rUtil.GetSubTable(oTbl보험계약사항, "@B3InsurObjDvs@");         //2.보험계약사항 - 담보위험
