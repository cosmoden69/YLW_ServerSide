...
{//
    public class RptAdjSLRptViewInvoiceOut2
    {
        private string myPath = Application.StartupPath;

        public RptAdjSLRptViewInvoiceOut2(string path)
        {
            this.myPath = path;
        }
        ...
        public Response GetReport(ReportParam para, ref string rptPath, ref string rptName)
        {
            try
            {
                ...
                string sSampleXSD = myPath + @"\보고서\출력설계_2715_서식_인보이스(물보험 외부용).xsd";
                ...
                string sSampleDocx = myPath + @"\보고서\출력설계_2715_서식_인보이스(물보험 외부용).docx";
                ...
                rptName = "인보이스출력_물보험(" + sfilename + ").docx";
