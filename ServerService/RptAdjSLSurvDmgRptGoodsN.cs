...
{
    public class RptAdjSLSurvDmgRptGoodsN
    {
        private string myPath = Application.StartupPath;

        public RptAdjSLSurvDmgRptGoodsN(string path)
        {
            this.myPath = path;
        }
        ...
        public Response GetReport(ReportParam para, ref string rptPath, ref string rptName)
        {
            try
            {
                ...
                string sSampleXSD = myPath + @"\보고서\출력설계_2631_서식_교부용 손해사정서_재물_표준.xsd";
                ...
                string sSampleDocx = myPath + @"\보고서\출력설계_2631_서식_교부용 손해사정서_재물_표준.docx";
